package com.example.appdcapplication.Adapter;
...
import com.example.appdcapplication.Common.Common;
import com.example.appdcapplication.ListDocumentActivity;
import com.example.appdcapplication.Model.Category;
import com.example.appdcapplication.R;
        ...
        public MyViewHolder(@NonNull View itemView)
        {
            ...
            card_category.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(context, ListDocumentActivity.class);
